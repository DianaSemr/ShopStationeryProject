...
public abstract class Stationery extends JPanel {
    @Override
    protected void paintComponent(Graphics g) {//метод отрисовывания объектов, в целом не особо сейчас нужен
    ...
    public abstract String getButtonName();//метод возвращающий имя класса
}

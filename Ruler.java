...
public class Ruler extends Stationery {
    ...
    public Ruler(){
        ...
        Basic panel1 = new Basic(400, 400, "https://images-na.ssl-images-amazon.com/images/I/71tWGvQ%2BxCL._AC_SL1500_.jpg", "52", "<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Тип — классическая.</p>"+"<p>Серия — ШКОЛЬНАЯ.</p>"+"<p>Длина шкалы — 20 см.</p>"+"<p>Материал — пластик.</p>"+"<p>Количество шкал — 1 шт.</p>"+"<p>Прозрачная — да.</p>"+"<p>Цвет — с дизайном.</p>"+"<p>Производитель — Китай.</p>"+"</html>");
        Basic panel2 = new Basic(400, 400, "https://paper66.ru/image/product_foto/image/products_images_2/goods/210284/2988be734fab40d2e95813944f80a1ca_xl.jpg", "46", "<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Тип — классическая.</p>"+"<p>Серия — Office.</p>"+"<p>Длина шкалы — 30 см.</p>"+"<p>Материал — пластик.</p>"+"<p>Количество шкал — 2 шт.</p>"+"<p>Прозрачная — да.</p>"+"<p>Цвет — бесцветный.</p>"+"<p>Производитель — Китай.</p>"+"</html>");
        Basic panel3 = new Basic(400, 400, "https://paper66.ru/image/product_foto/image/products_images_2/goods/210610/0a32d6f556aa0253db8dbe04b68ea207_xl.jpg", "86", "<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Тип — классическая.</p>"+"<p>Серия — нет.</p>"+"<p>Длина шкалы — 30 см.</p>"+"<p>Материал — пластик.</p>"+"<p>Количество шкал — 2 шт.</p>"+"<p>Прозрачная — да.</p>"+"<p>Цвет — бесцветный.</p>"+"<p>Производитель — Китай.</p>"+"</html>");
        ...
        Basic panel6 = new Basic(400, 400, "https://ae04.alicdn.com/kf/HTB1hOJPLSzqK1RjSZPcq6zTepXag.jpg", "33","<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Тип — классическая.</p>"+"<p>Серия — Metal.</p>"+"<p>Длина шкалы — 30 см.</p>"+"<p>Материал — металл.</p>"+"<p>Количество шкал — 2 шт.</p>"+"<p>Прозрачная — нет.</p>"+"<p>Цвет — серебряный.</p>"+"<p>Производитель — Китай.</p>"+"</html>");

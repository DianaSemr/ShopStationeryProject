...
public class Pencil extends Stationery {
    ...
    public Pencil() {
        ...
        Basic panel1 = new Basic(400, 400, "https://store.donanimhaber.com/61/37/d3/6137d3e856b6c0400d1e4a750cc1dab1.jpg", "32", "<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Твердость — HB.</p>"+"<p>Наличие ластика — да.</p>"+"<p>Диаметр грифеля — 2.3 мм.</p>"+"<p>Форма корпуса — шестигранная.</p>"+"<p>Ударопрочный грифель — да.</p>"+"<p>Материал корпуса — пластик.</p>"+"<p>Цвет корпуса — зеленый.</p>"+"<p>Производитель — Франция.</p>"+"</html>");
        Basic panel2 = new Basic(400, 400, "https://www.ukazka.ru/img/g/uk965753.jpg", "12", "<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Твердость — HB.</p>"+"<p>Наличие ластика — да.</p>"+"<p>Диаметр грифеля — 2.2 мм.</p>"+"<p>Форма корпуса — шестигранная.</p>"+"<p>Ударопрочный грифель — да.</p>"+"<p>Материал корпуса — пластик.</p>"+"<p>Цвет корпуса — зеленый.</p>"+"<p>Производитель — Россия.</p>"+"</html>");
        Basic panel3 = new Basic(400, 400, "https://m-tvortsa.ru/image/cache/import_files/ff/ffd6e469c0de11e5804a7427eadbbb15_b7219475e0fe11e99e810025229fdd64-1000x1340.jpg", "17", "<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Твердость — HB.</p>"+"<p>Наличие ластика — да.</p>"+"<p>Диаметр грифеля — 2.8 мм.</p>"+"<p>Форма корпуса — трехгранная.</p>"+"<p>Ударопрочный грифель — да.</p>"+"<p>Материал корпуса — дерево.</p>"+"<p>Цвет корпуса — красный/синий.</p>"+"<p>Производитель — Китай.</p>"+"</html>");
        Basic panel4 = new Basic(400, 400, "https://krasniykarandash.ru/upload/resize/618091/618091_800x800x70.jpg", "16", "<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Твердость — HB.</p>"+"<p>Наличие ластика — нет.</p>"+"<p>Диаметр грифеля — 2.8 мм.</p>"+"<p>Форма корпуса — трехгранная.</p>"+"<p>Ударопрочный грифель — да.</p>"+"<p>Материал корпуса — дерево.</p>"+"<p>Цвет корпуса — черный.</p>"+"<p>Производитель — Китай.</p>"+"</html>");
        Basic panel5 = new Basic(400, 400, "https://u-printer.ru/upload/iblock/bb5/cq88uyxhuddab4g4vlkpk98b19fizbs9.jpg", "8", "<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Твердость — HB.</p>"+"<p>Наличие ластика — да.</p>"+"<p>Диаметр грифеля — 2.05 мм.</p>"+"<p>Форма корпуса — круглая.</p>"+"<p>Ударопрочный грифель — да.</p>"+"<p>Материал корпуса — дерево.</p>"+"<p>Цвет корпуса — с дизайном.</p>"+"<p>Производитель — Китай.</p>"+"</html>");
        Basic panel6 = new Basic(400, 400, "https://fabercastells.ru/image/cache/catalog/Produkts/FR-111101-680x680.jpg", "17","<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Твердость — HB.</p>"+"<p>Наличие ластика — да.</p>"+"<p>Диаметр грифеля — 2.8 мм.</p>"+"<p>Форма корпуса — трехгранная.</p>"+"<p>Ударопрочный грифель — да.</p>"+"<p>Материал корпуса — дерево.</p>"+"<p>Цвет корпуса — фиолетовый/серебристый.</p>"+"<p>Производитель — Китай.</p>"+"</html>");

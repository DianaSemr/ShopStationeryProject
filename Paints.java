...
public class Paints extends Stationery {
    ...
    public Paints(){
        ...
        Basic panel6 = new Basic(400, 400, "https://cdn.leroymerlin.ru/lmru/image/upload/dpr_1.0,f_auto,q_auto,w_128,h_128,c_pad,b_white,d_photoiscoming.png/v1563969618/lmcode/BtOu1ghDJkyAYszAXGwLyA/82276532.png", "305","<html>"+"<p><h1>Характеристики</h1></p>"+ "<p>Цветовая палитра — белый.</p>"+"<p>Внешний вид — матовый.</p>"+"<p>Основа — водная.</p>"+"<p>Тип полимера — акрил.</p>"+"<p>Срок годности — 12 месяцев.</p>"+"<p>Производитель — Россия</p>"+"</html>");
